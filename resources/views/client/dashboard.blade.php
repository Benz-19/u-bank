        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
          ...
          <main class="relative z-0 flex-1 pb-8 px-6 bg-white">
              <div class="grid pb-10  mt-4 ">
                  <!-- Start Content-->
                    <div class="mb-2">
                      <p class="text-lg font-semibold text-gray-800">Invoices</p>
                    </div>
                      ...
                      <div class="col-span-12 sm:col-span-12 md:col-span-8 lg:col-span-8 xxl:col-span-8">
                        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 mt-3">
                           ...
                           <div class="p-4">
                              ...
                              <p class="text-xs font-semibold text-gray-800">Total Outstanding</p>
                           </div>
                           <div class="p-4">
                              <p class="text-xl font-bold">RM 9,200</p>
                              <p class="text-xs font-semibold text-gray-800">In Process</p>
                           </div>
                           <div class=" p-4">
                              <p class="text-xl font-bold">RM 5,700</p>
                              <p class="text-xs font-semibold text-gray-800">Paid Today</p>
                           </div>
                        </div>
                      </div>
                      <div class="col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-4 xxl:col-span-4">
                          <div class="p-4">
                              <p class="text-sm text-gray-800">Outstanding Revenue</p>
                              <div class="shadow w-full bg-gray-100 mt-2">
                                ...
                                <p class="text-xs font-semibold text-gray-800 mt-2">RM 45,941 Overdue</p>
                           </div>
                      </div>
                    </div>
